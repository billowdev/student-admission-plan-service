...
import { validateExtraAdmissonPlanQueryParams } from '../middlewares/extra-admission-plan.middleware';
...
// router.delete("/delete/:id", validateExtraAdmissionPlanId,extraAdminssionPlanControllers.handleDeleteExtraAdmissionPlan)
